                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{ $productDetail->image }}" id="current" alt="{{ $productDetail->image }}">
                                </div>
                                <div class="images">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            <h2 class="title">{{ $productDetail->name }}</h2>
                            <p class="category"><i class="lni lni-tag"></i> Category: <a href="javascript:void(0)">Action cameras</a></p>
                            <h3 class="price">
                                @if ($productDetail->sale_price)
                                {{ number_format($productDetail->sale_price, 0, ',', '.') }}đ
                                    <span>{{ number_format($productDetail->price, 0, ',', '.') }}đ</span>
                                    @else
                                    {{ number_format($productDetail->price, 0, ',', '.') }}đ
                                @endif
                            </h3>
                            <p class="info-text">{{ $productDetail->description }}</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-12">
                                    <div class="form-group quantity">
                                        ...
                                        min="1" max="{{$productDetail->quantity}}" value="1" name="quantity"
                                        >
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="single-block">
                            <div class="reviews">
                                ...
                                <div class="single-review">
                                    <img src="{{asset('')}}images/blog/comment1.jpg" alt="#">
                                ...
                                <!-- Start Single Review -->
                                <div class="single-review">
                                    <img src="{{asset('')}}images/blog/comment3.jpg" alt="#">
                                    <div class="review-info">
