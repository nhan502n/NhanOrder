            ...
            <div class="row">
                <div class="col-lg-8 col-12 custom-padding-right">
                    <div class="slider-head">
                        ...
                        style="background-image: url"{{ asset('') }}images/hero/slider-bg1.jpg);">
                                <div class="content">
                            ...
                            <!-- Start Single Slider -->
                            <div class="single-slider"
                        style="background-image: url"{{ asset('') }}images/hero/slider-bg2.jpg);">
                                <div class="content">
                ...
                <div class="col-lg-4 col-12">
                    <div class="row">
                        ...
                        style="background-image: url("{{ asset('') }}images/hero/slider-bnr.jpg');">
                                <div class="content">
                                    <h2>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <img src="{{ asset('') }}images/products/product-1.jpg" alt="#">
                            <div class="button">
                                <a href="chi-tiet-san-pham/{{$product->slug}}" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                            </div>
                        </div>
    ...
    <section class="banner section">
        <div class="container">
            ...
            <div class="single-banner" style="background-image:url('{{ asset('') }}images/banner/banner-1-bg.jpg')">
                ...
                style="background-image:url('{{ asset('') }}images/banner/banner-2-bg.jpg')">
                        <div class="content">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                    ...
                    <!-- Start Banner -->
                        ...
                        style="background-image: url('{{ asset('')}}images/banner/banner-3-bg.jpg '); margin-top: 30px;">
                        <div class="content">
