...
Route::get('/verify/{userId}', [UserController::class, 'showVerifyPrompt'])->name('verify.prompt');
Route::get('/verify/confirm/{token}', [UserController::class, 'confirm'])->name('verify.confirm');
Route::get('/verify/reject/{token}', [UserController::class, 'reject'])->name('verify.reject');
